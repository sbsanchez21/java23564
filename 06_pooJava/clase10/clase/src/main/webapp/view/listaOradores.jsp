  ...
  <body>
    ...
    <div class="container">
    	...
    	<table class="table text-center">
    		...
    		List<Orador> listOra=dao.listOradores();
    		
    		for(Orador orador: listOra){
    			out.println("<tr>");

    			out.println("<td>");
    			out.println(orador.getId());
    			out.println("</td>");

    			out.println("<td>");
    			out.println(orador.getNombre());
    			out.println("</td>");

    			out.println("<td>");
    			out.println(orador.getApellido());
    			out.println("</td>");

    			out.println("<td>");
    			out.println(orador.getEmail());
    			out.println("</td>");
    			
    			out.println("<td>");
    			out.println("<a href='#' data-bs-toggle='modal' data-bs-target='#deleteModal' idDel='"+orador.getId()+"'><i class='bi bi-trash-fill'></i></a>");
    			out.println("<a href='#' data-bs-toggle='modal' data-bs-target='#updateModal' idUpd='"+orador.getId()+"' nombre='"+orador.getNombre()+"' apellido='"+orador.getApellido()+"' email='"+orador.getEmail()+"'><i class='bi bi-pencil-fill'></i></a>");
    			out.println("</td>");    			
